'''
Q) Find the missing number in the given list of integers. The list contains 1 to 100 integers but one of the integer is missing. There are no duplicates in the list.
...
numberz=list(map(int,input().split())) 
sol=sum(numberz)
ans=(100*101)//2
print(ans-sol)
